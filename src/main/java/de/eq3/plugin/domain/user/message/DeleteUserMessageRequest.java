...
@PluginSentMessageDocumentation(
		messageType = PluginMessageType.Fields.DELETE_USER_MESSAGE_REQUEST,
		description = "Message sent by the plugin to delete a user messages created by the plugin to be shown "
				+ "in the Homematic IP smartphone app.",
		correspondingMessage = DeleteUserMessageResponse.class,
		envelope = PluginMessage.class)
public class DeleteUserMessageRequest implements Body {
	@FieldDocumentation(
			description = "Identifier of the user message to be deleted.",
