...
@SchemaDocumentation(
		description = "Schema of an error object that may be included in response messages sent by the plugin or "
				+ "Home Control Unit when an error occurs while processing a message.")
public class Error {
	@FieldDocumentation(
			description = "A code used to categorize the error, typically a number or enumerated type.",
